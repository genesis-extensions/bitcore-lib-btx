 ...
 * @returns {URI} A new valid and fro genesis instance of URI
 * @constructor
 */
...
URI.parse = function(uri) {
  ...
  if (info.protocol !== 'genesis:') {
    throw new TypeError('Invalid genesis URI');
  }
...
URI.prototype._fromObject = function(obj) {
  ...
  if (!Address.isValid(obj.address)) {
    throw new TypeError('Invalid genesis address');
  }
